...
balloonImage2.addAnimation("Images/HotAirBallon01.png",ballon)
  }
  else if(keyDown(RIGHT_ARROW)){
    updateHeight(10,0);
    // Agrega la animación del globo [usa balloonImage2]
    balloonImage2.addAnimation("Images/HotAirBallon02.png",ballon)
  }
  else if(keyDown(UP_ARROW)){
    updateHeight(0,-10);
    // Agrega la animación del globo [usa balloonImage2]
    balloonImage2.addAnimation("Images/HotAirBallon03.png",ballon)
